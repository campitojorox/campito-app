            ...
            <div style={{ display: 'flex', gap: '1.5rem', marginBottom: '0.2rem' }}>
              <div className="form-group" style={{ flex: 1, padding: 0 }}>
                ...
                <div className="input-with-icon" style={{ marginBottom: 0 }}>
                  ...
                  <input type="date" className="form-input" style={{ paddingLeft: '1rem', textAlign: 'right', paddingRight: '20px', fontSize: '0.95rem' }} required value={newDate} onChange={(e) => setNewDate(e.target.value)} />
                </div>
              </div>
              <div className="form-group" style={{ flex: 1, padding: 0 }}>
                ...
                <div className="input-with-icon" style={{ marginBottom: 0 }}>
                  <Calendar className="input-icon" size={18} style={{ left: '0.5rem' }} />
                  <input type="date" className="form-input" style={{ paddingLeft: '1rem', textAlign: 'right', paddingRight: '20px', fontSize: '0.95rem' }} required value={newEndDate} onChange={(e) => setNewEndDate(e.target.value)} />
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', marginBottom: '0.5rem' }}>
              <div className="form-group" style={{ flex: 1, padding: 0 }}>
                <div className="input-with-icon" style={{ marginBottom: 0 }}>
                  ...
                  <input type="time" className="form-input" style={{ paddingLeft: '1rem', textAlign: 'right', paddingRight: '20px', fontSize: '0.95rem' }} required value={newStartTime} onChange={(e) => setNewStartTime(e.target.value)} />
                </div>
              </div>
              <div className="form-group" style={{ flex: 1, padding: 0 }}>
                <div className="input-with-icon" style={{ marginBottom: 0 }}>
                  <Clock className="input-icon" size={18} style={{ left: '0.5rem' }} />
                  <input type="time" className="form-input" style={{ paddingLeft: '1rem', textAlign: 'right', paddingRight: '20px', fontSize: '0.95rem' }} required value={newEndTime} onChange={(e) => setNewEndTime(e.target.value)} />
                </div>
              </div>
            </div>
